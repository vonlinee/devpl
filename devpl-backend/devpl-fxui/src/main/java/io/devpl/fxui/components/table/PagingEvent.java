...
public class PagingEvent extends Event {
    ...
    public static final EventType<PagingEvent> ANY = new EventType<>(Event.ANY, "ANY");

    public static final EventType<PagingEvent> CHANGE = new EventType<>(ANY, "CHANGE");
    ...
    public PagingEvent(final @NamedArg("source") Object source, final @NamedArg("target") EventTarget target, final @NamedArg("eventType") EventType<PagingEvent> eventType) {
