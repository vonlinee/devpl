...
//        }
    ...
    public void saveConfig(ActionEvent event) {
        DatabaseInfo databaseConfig = extractConfigFromUi();
        if (StringUtils.allHasText(databaseConfig.getName(), databaseConfig.getHost(), databaseConfig.getPort(), databaseConfig.getUsername(), databaseConfig.getEncoding(), databaseConfig.getDbType(), databaseConfig.getSchema())) {
