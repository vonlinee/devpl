...
public class Base64 {
    ...
    public static String encodeObject(Serializable serializableObject, int options) throws IOException {
        ...
        try {
            ...
            b64os = new Base64.InternalOutputStream(baos, ENCODE | options);
            if ((options & GZIP) != 0) {
                // Gzip
    ...
    public static byte[] encodeBytesToBytes(byte[] source, int off, int len, int options) throws IOException {
        ...
        if ((options & GZIP) != 0) {
            ByteArrayOutputStream baos = null;
            java.util.zip.GZIPOutputStream gzos = null;
            Base64.InternalOutputStream b64os = null;
...
//        }
    ...
    public static void encodeToFile(byte[] dataToEncode, String filename) throws IOException {
        ...
        Base64.InternalOutputStream bos = null;
        try {
            bos = new Base64.InternalOutputStream(new FileOutputStream(filename), Base64.ENCODE);
    ...
    public static void decodeToFile(String dataToDecode, String filename) throws IOException {
        Base64.InternalOutputStream bos = null;
        try {
            bos = new Base64.InternalOutputStream(new FileOutputStream(filename), Base64.DECODE);
    ...
    public static byte[] decodeFromFile(String filename) throws IOException {
        ...
        Base64.InternalInputStream bis = null;
        try {
            ...
            // Open a stream
            bis = new Base64.InternalInputStream(new BufferedInputStream(new FileInputStream(file)), Base64.DECODE);
    ...
    public static String encodeFromFile(String filename) throws IOException {
        ...
        try {
            ...
            // Open a stream
            bis = new Base64.InternalInputStream(new BufferedInputStream(new FileInputStream(file)), Base64.ENCODE);
    ...
    /**
     * A {@link Base64.InternalInputStream} will read data from another
     * <code>InputStream</code>, given in the constructor,
     * and encode/decode to/from Base64 notation on the fly.
     *
     * @see Base64
     * @since 1.3
     */
    public static class InternalInputStream extends FilterInputStream {
        ...
        /**
         * Constructs a {@link Base64.InternalInputStream} in DECODE mode.
         *
         * @param in the <code>InputStream</code> from which to read data.
         * @since 1.3
         */
        public InternalInputStream(InputStream in) {
            this(in, DECODE);
        }   // end constructor


        /**
         * Constructs a {@link Base64.InternalInputStream} in
         ...
         * @since 2.0
         */
        public InternalInputStream(InputStream in, int options) {
            super(in);
    ...
    /**
     * A {@link Base64.InternalOutputStream} will write data to another
     * <code>OutputStream</code>, given in the constructor,
     * and encode/decode to/from Base64 notation on the fly.
     *
     * @see Base64
     * @since 1.3
     */
    private static class InternalOutputStream extends FilterOutputStream {
        ...
        /**
         * Constructs a {@link Base64.InternalOutputStream} in ENCODE mode.
         *
         * @param out the <code>OutputStream</code> to which data will be written.
         * @since 1.3
         */
        ...
        /**
         * Constructs a {@link Base64.InternalOutputStream} in
         * either ENCODE or DECODE mode.
         * <p>
         * Valid options:<pre>
         *   ENCODE or DECODE: Encode or Decode as data is read.
         ...
         * @since 1.3
         */
        public InternalOutputStream(OutputStream out, int options) {
            super(out);
            this.breakLines = (options & DO_BREAK_LINES) != 0;
            this.encode = (options & ENCODE) != 0;
