...
public class DatabaseIO {
     ...
     */
    public static final String XML_SCHEMA_NAMESPACE = "http://db.apache.org/ddlutils/schema/1.1";
    /**
     * Qualified name of the column element.
     */
    public static final QName QNAME_ELEMENT_COLUMN = new QName(XML_SCHEMA_NAMESPACE, "column");
    /**
     * Qualified name of the database element.
     */
    public static final QName QNAME_ELEMENT_DATABASE = new QName(XML_SCHEMA_NAMESPACE, "database");
    /**
     * Qualified name of the foreign-key element.
     */
    public static final QName QNAME_ELEMENT_FOREIGN_KEY = new QName(XML_SCHEMA_NAMESPACE, "foreign-key");
    /**
     * Qualified name of the index element.
     */
    public static final QName QNAME_ELEMENT_INDEX = new QName(XML_SCHEMA_NAMESPACE, "index");
    /**
     * Qualified name of the index-column element.
     */
    public static final QName QNAME_ELEMENT_INDEX_COLUMN = new QName(XML_SCHEMA_NAMESPACE, "index-column");
    /**
     * Qualified name of the reference element.
     */
    public static final QName QNAME_ELEMENT_REFERENCE = new QName(XML_SCHEMA_NAMESPACE, "reference");
    /**
     * Qualified name of the table element.
     */
    public static final QName QNAME_ELEMENT_TABLE = new QName(XML_SCHEMA_NAMESPACE, "table");
    /**
     * Qualified name of the unique element.
     */
    public static final QName QNAME_ELEMENT_UNIQUE = new QName(XML_SCHEMA_NAMESPACE, "unique");
    /**
     * Qualified name of the unique-column element.
     */
    public static final QName QNAME_ELEMENT_UNIQUE_COLUMN = new QName(XML_SCHEMA_NAMESPACE, "unique-column");
    /**
     * Qualified name of the autoIncrement attribute.
     */
    public static final QName QNAME_ATTRIBUTE_AUTO_INCREMENT = new QName(XML_SCHEMA_NAMESPACE, "autoIncrement");
    /**
     * Qualified name of the default attribute.
     */
    public static final QName QNAME_ATTRIBUTE_DEFAULT = new QName(XML_SCHEMA_NAMESPACE, "default");
    /**
     * Qualified name of the defaultIdMethod attribute.
     */
    public static final QName QNAME_ATTRIBUTE_DEFAULT_ID_METHOD = new QName(XML_SCHEMA_NAMESPACE, "defaultIdMethod");
    /**
     * Qualified name of the description attribute.
     */
    public static final QName QNAME_ATTRIBUTE_DESCRIPTION = new QName(XML_SCHEMA_NAMESPACE, "description");
    /**
     * Qualified name of the foreign attribute.
     */
    public static final QName QNAME_ATTRIBUTE_FOREIGN = new QName(XML_SCHEMA_NAMESPACE, "foreign");
    /**
     * Qualified name of the foreignTable attribute.
     */
    public static final QName QNAME_ATTRIBUTE_FOREIGN_TABLE = new QName(XML_SCHEMA_NAMESPACE, "foreignTable");
    /**
     * Qualified name of the javaName attribute.
     */
    public static final QName QNAME_ATTRIBUTE_JAVA_NAME = new QName(XML_SCHEMA_NAMESPACE, "javaName");
    /**
     * Qualified name of the local attribute.
     */
    public static final QName QNAME_ATTRIBUTE_LOCAL = new QName(XML_SCHEMA_NAMESPACE, "local");
    /**
     * Qualified name of the name attribute.
     */
    public static final QName QNAME_ATTRIBUTE_NAME = new QName(XML_SCHEMA_NAMESPACE, "name");
    /**
     * Qualified name of the onDelete attribute.
     */
    public static final QName QNAME_ATTRIBUTE_ON_DELETE = new QName(XML_SCHEMA_NAMESPACE, "onDelete");
    /**
     * Qualified name of the onUpdate attribute.
     */
    public static final QName QNAME_ATTRIBUTE_ON_UPDATE = new QName(XML_SCHEMA_NAMESPACE, "onUpdate");
    /**
     * Qualified name of the primaryKey attribute.
     */
    public static final QName QNAME_ATTRIBUTE_PRIMARY_KEY = new QName(XML_SCHEMA_NAMESPACE, "primaryKey");
    /**
     * Qualified name of the required attribute.
     */
    public static final QName QNAME_ATTRIBUTE_REQUIRED = new QName(XML_SCHEMA_NAMESPACE, "required");
    /**
     * Qualified name of the size attribute.
     */
    public static final QName QNAME_ATTRIBUTE_SIZE = new QName(XML_SCHEMA_NAMESPACE, "size");
    /**
     * Qualified name of the type attribute.
     */
    public static final QName QNAME_ATTRIBUTE_TYPE = new QName(XML_SCHEMA_NAMESPACE, "type");
    /**
     * Qualified name of the version attribute.
     */
    public static final QName QNAME_ATTRIBUTE_VERSION = new QName(XML_SCHEMA_NAMESPACE, "version");
    /**
    ...
    /**
     * @param schema 字符串定义的Schema
     * @return Database
     */
    public static Database read(String schema) {
        DatabaseIO dbIO = new DatabaseIO();
        dbIO.setUseInternalDtd(true);
        dbIO.setValidateXml(true);
        return dbIO.read(new StringReader(schema));
    }
    ...
    /**
     * Compares the given tow qname. This specifically ignores the namespace
    ...
    public void write(Database model, OutputStream output) throws DdlUtilsXMLException {
        ...
        xmlWriter.setDefaultNamespace(XML_SCHEMA_NAMESPACE);
    ...
    public void write(Database model, Writer output) throws DdlUtilsXMLException {
        XmlWriter xmlWriter = new PrettyPrintingXmlWriter(output, StandardCharsets.UTF_8.name());
        xmlWriter.setDefaultNamespace(XML_SCHEMA_NAMESPACE);
        xmlWriter.writeDocumentStart();
        writeDatabaseElement(model, xmlWriter);
        xmlWriter.writeDocumentEnd();
     ...
     */
    private void writeDatabaseElement(Database model, XmlWriter xmlWriter) throws DdlUtilsXMLException {
        writeElementStart(xmlWriter, QNAME_ELEMENT_DATABASE);
        xmlWriter.writeNamespace(null, XML_SCHEMA_NAMESPACE);
     ...
     * @param xmlWriter The XML writer
     */
    private void writeTableElement(Table table, XmlWriter xmlWriter) throws DdlUtilsXMLException {
     ...
     * @param xmlWriter The XML writer
     */
    private void writeColumnElement(Column column, XmlWriter xmlWriter) throws DdlUtilsXMLException {
     ...
     * @param xmlWriter  The XML writer
     */
    private void writeForeignKeyElement(ForeignKey foreignKey, XmlWriter xmlWriter) throws DdlUtilsXMLException {
        xmlWriter.indentIfPrettyPrinting(2);
     ...
     * @param xmlWriter The XML writer
     */
    private void writeReferenceElement(Reference reference, XmlWriter xmlWriter) throws DdlUtilsXMLException {
     ...
     * @param xmlWriter The XML writer
     */
    private void writeIndexElement(Index index, XmlWriter xmlWriter) throws DdlUtilsXMLException {
        xmlWriter.indentIfPrettyPrinting(2);
     ...
     * @param xmlWriter   The XML writer
     */
    private void writeIndexColumnElement(IndexColumn indexColumn, boolean isUnique, XmlWriter xmlWriter) throws DdlUtilsXMLException {
        xmlWriter.indentIfPrettyPrinting(3);
     ...
     */
    private void writeElementStart(XmlWriter xmlWriter, QName qName) throws DdlUtilsXMLException {
     ...
     */
    private void writeAttribute(XmlWriter xmlWriter, QName qName, String value) throws DdlUtilsXMLException {
        if (value != null) {
     ...
     * @param xmlWriter The xml writer
     */
    private void writeElementEnd(XmlWriter xmlWriter) throws DdlUtilsXMLException {
