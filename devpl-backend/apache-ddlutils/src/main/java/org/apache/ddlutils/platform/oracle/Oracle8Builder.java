...
public class Oracle8Builder extends SqlBuilder {
    ...
    protected void writeCastExpression(Column sourceColumn, Column targetColumn) throws IOException {
        boolean sizeChanged = TypeMap.isTextType(targetColumn.getTypeCode()) && ColumnDefinitionChange.isSizeChanged(getPlatformInfo(), sourceColumn, targetColumn) && !StringUtils.isEmpty(targetColumn.getSize());
