...
public class PostgreSqlPlatform extends PlatformImplBase {
    ...
    public PostgreSqlPlatform() {
        ...
        setModelReader(new PostgresSqlModelReader(this));
    }
    ...
    private void createOrDropDatabase(String jdbcDriverClassName, String connectionUrl, String username, String password, ContextMap parameters, boolean createDb) throws DatabaseOperationException, UnsupportedOperationException {
        if (JDBCDriverTypeEnum.POSTGRE_SQL.getDriverClassName().equals(jdbcDriverClassName)) {
            ...
            try {
                ...
                JdbcUtils.closeQuietly(stmt, connection);
            }
        } else {
    ...
    public void dropDatabase(String jdbcDriverClassName, String connectionUrl, String username, String password) throws DatabaseOperationException, UnsupportedOperationException {
        // With PostgresSQL, you create a database by executing "DROP DATABASE" in an existing database (usually
        // the template1 database because it usually exists)
