...
public class PlatformConfiguration {
     ...
     */
    public void setDataSource(PooledDataSourceWrapper dataSource) {
     ...
     * @return The platform
     */
    public Platform getPlatform() throws DdlUtilsTaskException {
        if (_platform == null) {
            ...
            try {
                ...
                throw new DdlUtilsTaskException("Database type " + _databaseType + " is not supported.", ex);
            }
            if (_platform == null) {
                throw new DdlUtilsTaskException("Database type " + _databaseType + " is not supported.");
            }
