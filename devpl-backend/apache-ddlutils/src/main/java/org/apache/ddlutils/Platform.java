...
public interface Platform {
     ...
     */
    boolean exists(Database model, TableRow dynaBean);
     ...
     * @return <code>true</code> if a bean with this primary key exists in the database
     */
    boolean exists(Connection connection, Database model, TableRow dynaBean);
     ...
     */
    void store(Database model, TableRow dynaBean) throws DatabaseOperationException;
     ...
     * @param dynaBean   The bean to store
     */
    void store(Connection connection, Database model, TableRow dynaBean) throws DatabaseOperationException;
     ...
     */
    String getInsertSql(Database model, TableRow dynaBean);
     ...
     */
    void insert(Database model, TableRow dynaBean) throws DatabaseOperationException;
     ...
     */
    void insert(Connection connection, Database model, Collection<TableRow> dynaBeans) throws DatabaseOperationException;
     ...
     */
    String getUpdateSql(Database model, TableRow dynaBean);
     ...
     * @return The update sql
     */
    String getUpdateSql(Database model, TableRow oldDynaBean, TableRow newDynaBean);
     ...
     * @param dynaBean The bean
     */
    void update(Database model, TableRow dynaBean) throws DatabaseOperationException;
     ...
     * @param dynaBean   The bean
     */
    void update(Connection connection, Database model, TableRow dynaBean) throws DatabaseOperationException;
     ...
     */
    void update(Database model, TableRow oldDynaBean, TableRow newDynaBean) throws DatabaseOperationException;
     ...
     * @param newDynaBean The bean containing the new data
     */
    void update(Connection connection, Database model, TableRow oldDynaBean, TableRow newDynaBean) throws DatabaseOperationException;
     ...
     * @return The sql
     */
    String getDeleteSql(Database model, TableRow dynaBean);
     ...
     */
    void delete(Database model, TableRow dynaBean) throws DatabaseOperationException;
     ...
     * @param connection The database connection
     */
    void delete(Connection connection, Database model, TableRow dynaBean) throws DatabaseOperationException;
