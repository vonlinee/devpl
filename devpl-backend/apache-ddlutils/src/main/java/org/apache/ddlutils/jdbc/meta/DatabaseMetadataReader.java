...
public interface DatabaseMetadataReader {
     ...
     * @throws SQLException exception when access to database.
     */
     ...
     * @param schema      schema
     * @param table       table
     * @param unique      true if unique index wanted, or false.
     * @param approximate approximate
     * @return IndexMetadata
     * @throws SQLException exception occurs when access to database.
     */
