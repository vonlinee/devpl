...
public final class PooledDataSourceWrapper implements DataSource, AutoCloseable {
    ...
    public static PooledDataSourceWrapper wrap(DataSource dataSource) {
        if (dataSource instanceof PooledDataSourceWrapper) {
            return (PooledDataSourceWrapper) dataSource;
        }
