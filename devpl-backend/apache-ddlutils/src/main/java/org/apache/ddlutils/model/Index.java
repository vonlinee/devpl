...
public interface Index extends Serializable {
     ...
     * @return <code>true</code> if this index is equal (ignoring case) to the given one
     */
    default boolean equals(Index otherIndex, boolean caseSensitive) {
        return caseSensitive ? this.equals(otherIndex) : this.equalsIgnoreCase(otherIndex);
    }
    ...
    /**
     * check if this index is union index.
     *
     * @return if this index is union index.
     */
    default boolean isUnionIndex() {
