...
public abstract class Command {
     ...
     */
    protected void handleException(Exception ex, String msg) throws DdlUtilsTaskException {
        if (isFailOnError()) {
            if (ex instanceof DdlUtilsTaskException) {
                throw (DdlUtilsTaskException) ex;
            } else {
                throw new DdlUtilsTaskException(msg, ex);
            }
        } else {
            _log.error(msg, ex);
        }
     ...
     */
    public abstract void execute(DatabaseTask task, Database model) throws DdlUtilsTaskException;
}
