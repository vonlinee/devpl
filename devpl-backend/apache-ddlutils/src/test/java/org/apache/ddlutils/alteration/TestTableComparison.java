...
public class TestTableComparison extends TestComparisonBase {
    ...
    public void testAddColumn() {
        ...
        assertEquals("TableA", change.getChangedTableName());
        assertColumn("Col1", Types.DOUBLE, null, null, false, false, false, change.getNewColumn());
    ...
    public void testAddAutoIncrementColumn() {
        ...
        assertEquals("TableA", change.getChangedTableName());
        assertColumn("ColA", Types.INTEGER, null, null, false, false, true, change.getNewColumn());
        assertEquals("ColPK", change.getPreviousColumn());
        assertNull(change.getNextColumn());
    }
    ...
    public void testAddRequiredColumn() {
        ...
        assertEquals("TableA", change.getChangedTableName());
        assertColumn("ColA", Types.INTEGER, null, null, false, true, false, change.getNewColumn());
        assertEquals("ColPK", change.getPreviousColumn());
        assertNull(change.getNextColumn());
    }
    ...
    public void testAddColumnWithSizeAndDefaultValue() {
        ...
        assertEquals("TableA", change.getChangedTableName());
        assertColumn("COLA", Types.VARCHAR, "32", "text", false, false, false, change.getNewColumn());
        assertEquals("ColPK", change.getPreviousColumn());
        assertNull(change.getNextColumn());
    }
    ...
    public void testMakeColumnRequired() {
        ...
        assertEquals("TableA", change.getChangedTableName());
        assertColumn("Col", Types.INTEGER, null, null, false, true, false, change.getNewColumn());
    }
    ...
    public void testMakeColumnNotRequired() {
        ...
        assertEquals("TableA", change.getChangedTableName());
        assertColumn("Col", Types.INTEGER, null, null, false, false, false, change.getNewColumn());
    }
    ...
    public void testMakeColumnAutoIncrement() {
        ...
        assertEquals("TableA", change.getChangedTableName());
        assertColumn("Col", Types.INTEGER, null, null, false, false, true, change.getNewColumn());
    }
    ...
    public void testChangeColumnDataType2() {
        ...
        assertEquals("TableA", change.getChangedTableName());
        assertColumn("Col", Types.VARCHAR, "32", null, false, false, false, change.getNewColumn());
    }
    ...
    public void testChangeColumnDataType3() {
        ...
        assertEquals("TableA", change.getChangedTableName());
        assertColumn("Col", Types.NUMERIC, "10,5", null, false, false, false, change.getNewColumn());
    }
    ...
    public void testChangeColumnDataType4() {
        ...
        assertEquals("TableA", change.getChangedTableName());
        assertColumn("Col", Types.CHAR, "32", null, false, false, false, change.getNewColumn());
    }
    ...
    public void testChangeColumnDataType5() {
        ...
        assertEquals("TableA", change.getChangedTableName());
        assertColumn("Col", Types.NUMERIC, "32,5", null, false, false, false, change.getNewColumn());
    }
    ...
    public void testChangeColumnDataType7() {
        ...
        assertEquals("TableA", change.getChangedTableName());
        assertColumn("Col", Types.FLOAT, null, null, false, false, false, change.getNewColumn());
    }
    ...
    public void testChangeColumnDataType8() {
        ...
        assertEquals("TableA", change.getChangedTableName());
        assertColumn("Col", Types.TIMESTAMP, null, null, false, false, false, change.getNewColumn());
    }
    ...
    public void testChangeColumnPrecisionAndScale() {
        ...
        assertEquals("TableA", change.getChangedTableName());
        assertColumn("Col", Types.DECIMAL, "32,7", null, false, false, false, change.getNewColumn());
    }
    ...
    public void testAddDefaultValue() {
        ...
        assertEquals("TableA", change.getChangedTableName());
        assertColumn("Col", Types.INTEGER, null, "0", false, false, false, change.getNewColumn());
    }
    ...
    public void testChangeDefaultValue() {
        ...
        assertEquals("TableA", change.getChangedTableName());
        assertColumn("Col", Types.INTEGER, null, "2", false, false, false, change.getNewColumn());
    }
    ...
    public void testRemoveDefaultValue() {
        ...
        assertEquals("TableA", change.getChangedTableName());
        assertColumn("Col", Types.VARCHAR, "16", null, false, false, false, change.getNewColumn());
    }
    ...
    public void testMakeColumnRequiredWithDefaultValue() {
        ...
        assertEquals("TableA", change.getChangedTableName());
        assertColumn("Col", Types.INTEGER, null, "0", false, true, false, change.getNewColumn());
    }
    ...
    public void testAddColumnAndChangeColumnOrder() {
        ...
        assertEquals("TableA", change1.getChangedTableName());
        assertEquals(2, change1.getNewPosition("Col1", false));
        assertEquals(1, change1.getNewPosition("Col2", false));

        assertEquals("TableA", change2.getChangedTableName());
        assertColumn("Col3", Types.VARCHAR, "32", null, false, false, false, change2.getNewColumn());
