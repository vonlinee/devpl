...
public class TestAddColumn extends TestAgainstLiveDatabaseBase {
    ...
    public void testAddUniqueIndexAndColumn() {
        // TODO
        if (!getPlatformInfo().isIndicesSupported() || BuiltinDatabaseType.INTERBASE.getName().equals(getPlatform().getName())) {
            return;
        }
    ...
    public void testAddFKAndLocalRequiredColumn() {
        // TODO
        if (BuiltinDatabaseType.MYSQL.getName().equals(getPlatform().getName()) || BuiltinDatabaseType.MYSQL5.getName().equals(getPlatform().getName())) {
