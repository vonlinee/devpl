...
public class TestAlteration extends TestAgainstLiveDatabaseBase {
    ...
    public void testChangeColumnOrderWithAutoIncrementPK() {
        ...
        if (BuiltinDatabaseType.SYBASE.getName().equals(getPlatform().getName())) {
            model1Xml = """
                <?xml version='1.0' encoding='ISO-8859-1'?>
                <database xmlns='http://db.apache.org/ddlutils/schema/1.1' name='roundtriptest'>
                  <table name='roundtrip'>
    ...
    public void testDropFKAndCorrespondingIndex() {
        if (!getPlatformInfo().isIndicesSupported() || BuiltinDatabaseType.FIREBIRD.getName().equals(getPlatform().getName())) {
    ...
    public void testDropFKAndDifferentIndexWithSameName() {
        ...
        if (!getPlatformInfo().isIndicesSupported() || BuiltinDatabaseType.MYSQL.getName().equals(getPlatform().getName()) || BuiltinDatabaseType.MYSQL5.getName().equals(getPlatform().getName()) || BuiltinDatabaseType.FIREBIRD.getName().equals(getPlatform().getName())) {
            return;
        }
    ...
    public void testRenamePK() throws Exception {
        ...
        if (BuiltinDatabaseType.MCKOI.getName().equals(getPlatform().getName())) {
