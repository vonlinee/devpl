...
public class PlatformInfo {
     ...
     */
    private final Map<Integer, String> _nativeTypes = new HashMap<>();
    /**
     * Contains the jdbc types corresponding to the native types for non-default mappings.
     */
    private final Map<Integer, Integer> _targetJdbcTypes = new HashMap<>();
     ...
     */
    private final MultiValueMap<CascadeActionEnum, CascadeActionEnum> _equivalentOnUpdateActions = new MultiValueMap<>();
    /**
     * Contains for each ON DELETE action the list of equivalent actions.
     */
    private final MultiValueMap<CascadeActionEnum, CascadeActionEnum> _equivalentOnDeleteActions = new MultiValueMap<>();
    /**
    ...
    public int getTargetJdbcType(int typeCode) {
        return _targetJdbcTypes.getOrDefault(typeCode, typeCode);
    }
    ...
    public void addEquivalentOnUpdateActions(CascadeActionEnum actionA, CascadeActionEnum actionB) {
        if (!actionA.equals(actionB)) {
            _equivalentOnUpdateActions.addAll(actionA, actionB);
            _equivalentOnUpdateActions.addAll(actionB, actionA);
        }
    }
    ...
    public boolean areEquivalentOnUpdateActions(CascadeActionEnum actionA, CascadeActionEnum actionB) {
        return _equivalentOnUpdateActions.containsValue(actionA, actionB);
    }
    ...
    public void addEquivalentOnDeleteActions(CascadeActionEnum actionA, CascadeActionEnum actionB) {
        if (!actionA.equals(actionB)) {
            _equivalentOnDeleteActions.addAll(actionA, actionB);
            _equivalentOnDeleteActions.addAll(actionB, actionA);
        }
    }
    ...
    public boolean areEquivalentOnDeleteActions(CascadeActionEnum actionA, CascadeActionEnum actionB) {
        return _equivalentOnDeleteActions.containsValue(actionA, actionB);
    }
}
