...
public abstract class CollectionUtils {
    ...
    public static <E, V> String join(Collection<E> list, Function<E, V> mapper) {
        return join(list, mapper, String::valueOf);
    }

    public static <E, V> String join(Collection<E> list, Function<E, V> mapper, Function<V, String> toStringMapper) {
        return join(list, mapper, ",");
    }

    public static <E, V> String join(Collection<E> list, Function<E, V> mapper, CharSequence delimiter) {
        return join(list, mapper, delimiter, String::valueOf);
    }

    public static <E, V> String join(Collection<E> list, Function<E, V> mapper, CharSequence delimiter, Function<V, String> toStringMapper) {
