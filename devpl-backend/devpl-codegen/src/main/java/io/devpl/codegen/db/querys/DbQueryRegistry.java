...
public class DbQueryRegistry {
    ...
    private static final EnumMap<DBType, DatabaseDialect> db_query_enum_map = new EnumMap<>(DBType.class);

    static {
        db_query_enum_map.put(DBType.ORACLE, new OracleQuery());
        db_query_enum_map.put(DBType.SQL_SERVER, new SqlServerQuery());
        db_query_enum_map.put(DBType.POSTGRE_SQL, new PostgresSqlQuery());
