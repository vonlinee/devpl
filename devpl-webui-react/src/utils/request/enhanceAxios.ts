 ...
 *
 */
export interface AxiosError<ServerResponse = any, RequestData = any>
  extends Error {
  config: CustomRequestConfig<RequestData>;
  code?: string;
  request?: any;
  response?: AxiosResponse<
    ServerResponse | Blob | ArrayBuffer | string,
    RequestData
  >;
...
type GetServerResponse<ResponseData> = ResponseData extends
  ...
  | string
  ? ResponseData
  : ServerResponseNormal<ResponseData>;
...
export interface AxiosEnhanced<ServerResponse = any> {
  ...
  request<
    ResponseData = any,
    ParamsData = any,
    Config = CustomRequestConfig<ParamsData, never | true>
  >(
    config: Config
  ...
  request<
    ResponseData = any,
    ParamsData = any,
    Config = CustomRequestConfig<ParamsData, false>
  >(
    config: Config
  ...
  getWrap<
    Params = any,
    ResponseData = any,
    Config = CustomRequestConfig<Params, never | true>
  >(
    url: string,
  ...
  getWrap<
    Params = any,
    ResponseData = any,
    Config = CustomRequestConfig<Params, false>
  >(
    url: string,
    configDefault?: Config
  ): (
    params?: Params,
    config?: Config
  ) => Promise<ServerResponseNormal<ResponseData>>;
  ...
  optionsWrap<
    ResponseData = any,
    Config = CustomRequestConfig<any, never | true>
  >(
    url: string,
    config?: Config
  ): (config?: Config) => Promise<ResponseData>;
  ...
  postWrap<
    Params = any,
    ResponseData = any,
    Config = CustomRequestConfig<any, false>
  >(
    url: string,
    config?: Config
  ): (
 ...
 *
 */
export interface AxiosInstanceEnhanced<ServerResponse = any>
  extends AxiosEnhanced<ServerResponse> {
  (config: AxiosRequestConfig): AxiosPromise;
  (url: string, config?: AxiosRequestConfig): AxiosPromise;
}

export interface AxiosStaticEnhanced<ServerResponse = any>
  extends AxiosInstanceEnhanced<ServerResponse> {
  /**
   * 创建请求实例
   * @param config 请求配置
   */
  create(
    config?: CustomRequestConfig<any>
  ): AxiosInstanceEnhanced<ServerResponse>;
  Cancel: CancelStatic;
 ...
 * @returns
 */
export function enhanceAxios<ServerResponse = any>(
  axios: AxiosStatic
): AxiosStaticEnhanced<ServerResponse> {
  ...
  axiosProto.getWrap = function (url: string, config?: AxiosRequestConfig) {
    ...
    return (params?: any, config?: CustomRequestConfig<any>) =>
      this.get(url, Object.assign({ ..._config }, config, { params })) as any;
  };
  axiosProto.deleteWrap = function (url: string, config?: AxiosRequestConfig) {
    ...
    return (params?: any, config?: CustomRequestConfig<any>) =>
      this.delete(
        url,
        Object.assign({ ..._config }, config, { params })
      ) as any;
  };
  axiosProto.headWrap = function (url: string, config?: AxiosRequestConfig) {
    const _config = config;
    return (config?: CustomRequestConfig<any>) =>
      this.head(url, Object.assign({ ..._config }, config)) as any;
  };
  axiosProto.optionsWrap = function (url: string, config?: AxiosRequestConfig) {
    const _config = config;
    return (config?: CustomRequestConfig<any>) =>
      this.options(url, Object.assign({ ..._config }, config)) as any;
  };
  axiosProto.postWrap = function (url: string, config?: AxiosRequestConfig) {
    const _config = config;
    return (data?: any, config?: CustomRequestConfig<any>) =>
      this.post(url, data, Object.assign({ ..._config }, config)) as any;
  };
  axiosProto.putWrap = function (url: string, config?: AxiosRequestConfig) {
    const _config = config;
    return (data?: any, config?: CustomRequestConfig<any>) =>
      this.put(url, data, Object.assign({ ..._config }, config)) as any;
  };
  axiosProto.patchWrap = function (url: string, config?: AxiosRequestConfig) {
    const _config = config;
    return (data?: any, config?: CustomRequestConfig<any>) =>
      this.patch(url, data, Object.assign({ ..._config }, config)) as any;
  };
  return axios as unknown as AxiosStaticEnhanced<ServerResponse>;
}
