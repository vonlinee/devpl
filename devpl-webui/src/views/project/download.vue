  ...
  <el-dialog v-model="visible" title="源码下载" :close-on-click-modal="false">
    ...
    >
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="项目包名" prop="projectPackage">
            <el-input
              v-model="dataForm.projectPackage"
              placeholder="项目包名"
              disabled
            ></el-input>
          </el-form-item>
      ...
      <el-form-item label="项目名" prop="modifyProjectName">
        <el-input
          v-model="dataForm.modifyProjectName"
          placeholder="项目名"
        ></el-input>
      </el-form-item>
      <el-row>
        <el-col :span="12">
          <el-form-item label="项目标识" prop="modifyProjectCode">
            <el-input
              v-model="dataForm.modifyProjectCode"
              placeholder="项目标识"
            ></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="项目包名" prop="modifyProjectPackage">
            <el-input
              v-model="dataForm.modifyProjectPackage"
              placeholder="项目包名"
            ></el-input>
          </el-form-item>
        </el-col>
