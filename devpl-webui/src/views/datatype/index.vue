  ...
  <el-card>
    ...
    >
      <el-form-item>
        <el-form-item>
          <el-select
            v-model="state.queryForm.typeGroupId"
            placeholder="类型分组"
          >
            <el-option
        ...
        <el-form-item>
          <el-input
            v-model="state.queryForm.typeKey"
            placeholder="类型Key"
          ></el-input>
        </el-form-item>
        <el-form-item>
          <el-input
            v-model="state.queryForm.typeName"
            placeholder="类型名称"
          ></el-input>
        </el-form-item>
      </el-form-item>
      ...
      <el-form-item>
        <el-button type="primary" @click="showTypeMappingTable"
          >类型映射表</el-button
        >
      </el-form-item>
      <el-form-item>
        <el-button type="danger" @click="typeGroupManagerRef.show()"
          >类型分组</el-button
        >
      </el-form-item>
    </el-form>
    ...
    <el-pagination
      ...
      :page-sizes="state.pageSizes ? state.pageSizes : []"
