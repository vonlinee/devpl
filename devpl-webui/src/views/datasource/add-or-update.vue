  ...
  <vxe-modal width="50%" v-model="visible" :title="!dataForm.id ? '新增' : '修改'" :mask-closable="false" :draggable="true"
    ...
    <el-form ref="dataFormRef" label-position="right" :model="dataForm" :rules="dataRules" label-width="120px"
      ...
      <el-form-item prop="dbType" label="数据库名称">
        <el-select v-model="dataForm.databaseName" clearable placeholder="数据库名称" @blur="selectBlur"
          @change="onDbNameChange" @visibleChange="onStartSelect" filterable style="width: 100%">
