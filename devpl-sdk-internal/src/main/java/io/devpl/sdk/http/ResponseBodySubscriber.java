 ...
 * 参考实现：
 */
public class ResponseBodySubscriber extends InputStream implements HttpResponse.BodySubscriber<InputStream> {
    ...
    public ResponseBodySubscriber() {
        this(MAX_BUFFERS_IN_QUEUE);
    }

    ResponseBodySubscriber(int maxBuffers) {
    ...
    public void onError(Throwable thrwbl) {
        ...
        boolean offer = buffers.offer(LAST_LIST);
    }
