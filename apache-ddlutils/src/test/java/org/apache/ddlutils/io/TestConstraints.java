...
public class TestConstraints extends TestAgainstLiveDatabaseBase {
     ...
     * methods of the {@link DatabasePlatform} with the read-back model.
    ...
    public void testLongTableName() {
        ...
        String tableName = StringUtils.repeat("org.apache.ddlutils.Test", (getSqlBuilder().getMaxTableNameLength() / 4) + 3);
    ...
    public void testLongColumnName() {
        ...
        String columnName = StringUtils.repeat("org.apache.ddlutils.Test", (getSqlBuilder().getMaxColumnNameLength() / 4) + 3);
        final String modelXml =
                "<?xml version='1.0' encoding='ISO-8859-1'?>\n" +
                        "<database xmlns='" + DatabaseIO.DDLUTILS_NAMESPACE + "' name='roundtriptest'>\n" +
    ...
    public void testLongConstraintName() {
        ...
        String constraintName = StringUtils.repeat("org.apache.ddlutils.Test", (getSqlBuilder().getMaxConstraintNameLength() / 4) + 3);
        final String modelXml =
                "<?xml version='1.0' encoding='ISO-8859-1'?>\n" +
                        "<database xmlns='" + DatabaseIO.DDLUTILS_NAMESPACE + "' name='roundtriptest'>\n" +
    ...
    public void testLongForeignKeyName() {
        ...
        String fkName = StringUtils.repeat("org.apache.ddlutils.Test", (getSqlBuilder().getMaxForeignKeyNameLength() / 4) + 3);
        final String modelXml =
                "<?xml version='1.0' encoding='ISO-8859-1'?>\n" +
                        "<database xmlns='" + DatabaseIO.DDLUTILS_NAMESPACE + "' name='roundtriptest'>\n" +
    ...
    /**
     * org.apache.ddlutils.Test for DDLUTILS-199.
     */
    ...
    public void testForeignKeyWithOnUpdateRestrict() {
        ...
        try {
            updateRow("roundtrip_1", (DynaBean) beansTable1.get(0), new Object[]{(5)});
            fail();
        } catch (DdlUtilsException ex) {
        }
    }
    ...
    public void testForeignKeyWithOnUpdateCascade() {
        ...
        updateRow("roundtrip_1", (DynaBean) beansTable1.get(0), new Object[]{(2)});
    ...
    public void testForeignKeyWithOnUpdateSetDefault() {
        ...
        updateRow("roundtrip_1", (DynaBean) beansTable1.get(1), new Object[]{(0)});
